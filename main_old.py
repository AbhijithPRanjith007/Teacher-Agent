...
def start_agent_session(session_id, is_audio=False, audio_input_only=False):
    ...
    # If audio_input_only is True, user speaks but wants text response
    # If is_audio is True and audio_input_only is False, full audio mode
    ...
    # Add output audio transcription when full audio mode is enabled
